...
Object.defineProperties(proto,
{
	...
	timing:
	{
		...
		get: function()
		{
			var lastRunner = this.lastRunner();
...
deprecate.property(proto, 'methodKey',
	'use `runtime.action` instead of `runtime.methodKey`');
deprecate.property(proto, 'timing', '`runtime.timing` will be remove');

_.extend(proto,
{
	lastFlow: deprecate.function(proto.lastRunner,
		'use `runtime.lastRunner` instead of `runtime.lastFlow`')
});
