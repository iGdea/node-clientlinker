...
Object.defineProperties(Timing.prototype,
{
	...
	navigationStart:
	{
		...
		get: function()
		{
			return this.runner.thisTry.timing.navigationStart;
		}
	}
});
...
deprecate.property(Timing.prototype, 'flowsStart',
	'use `runtime.flowsStart` instead of `timing.lastRunner().startTime`');
deprecate.property(Timing.prototype, 'flowsEnd',
	'use `runtime.flowsEnd` instead of `timing.lastRunner().endTime`');
