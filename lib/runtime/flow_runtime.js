...
deprecate.property(proto, 'timing',
	'use `runner.timline` instead of `runner.timing`');


function Timline(runner)
{
	this.runner = runner;
}

Object.defineProperties(Timline.prototype,
{
	start:
	{
		configurable: true,
...
deprecate.property(Timline.prototype, 'navigationStart',
	'use `runtime.navigationStart` instead of `runner.timline.navigationStart`');
deprecate.property(Timline.prototype, 'start',
	'use `runner.startTime` instead of `runner.timline.start`');
deprecate.property(Timline.prototype, 'end',
	'use `runner.endTime` instead of `runner.timline.end`');
